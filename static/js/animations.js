...
function getTranslation(key, lang) {
    const translations = {
        ...
        'emoji_pop_desc': {
            ...
            'es': '¡Haz clic en emojis rápidamente para crear combos! La dificultad aumenta con tu multiplicador: ¡alcanza 6x para el máximo desafío en 30 segundos!',
            'zh': '快速点击表情符号来建立连击！难度会随着倍数提升而增加——30秒内达到6倍，挑战极限！',
            'fr': 'Cliquez rapidement sur les emojis pour faire des combos ! La difficulté augmente avec votre multiplicateur - atteignez 6x pour un défi maximal en 30 secondes !',
            'hi': 'तेज़ी से इमोजी पर क्लिक करें और कॉम्बो बनाएं! कठिनाई आपके मल्टीप्लायर के साथ बढ़ती है - 30 सेकंड में 6x तक पहुँचें अधिकतम चुनौती के लिए!',
            'tl': 'Mag-click ng mga emoji nang mabilis para makabuo ng combo! Tumataas ang hirap habang tumataas ang multiplier mo – abutin ang 6x para sa pinakamalupit na hamon sa loob ng 30 segundo!',
            'ja': '絵文字を素早くクリックしてコンボを作ろう！マルチプライヤーが上がるごとに難易度もアップ。30秒で6倍に到達して最大のチャレンジに挑戦！'
        },
        'emoji_catch_title': {
            'en': 'Emoji Catch',
            'es': 'Atrapa Emojis',
        ...
        'emoji_catch_instructions': {
            'en': 'Move your basket anywhere on screen to catch falling good emojis! Avoid the 5 types of glowing red bad emojis (💣☠️👻🔥💀). Start with 3 hearts - lose one per bad catch. Visual warnings show when danger is near!',
            'es': '¡Mueve tu cesta por toda la pantalla para atrapar emojis buenos que caen! Evita los 5 tipos de emojis malos rojos brillantes (💣☠️👻🔥💀). Comienza con 3 corazones - pierdes uno por cada captura mala. ¡Las advertencias visuales muestran cuando el peligro está cerca!',
            'zh': '在屏幕上任意移动你的篮子来捕捉掉落的好表情符号！避开5种发光的红色坏表情符号（💣☠️👻🔥💀）。从3颗心开始 - 每次抓到坏表情符号失去一颗。视觉警告显示危险接近！',
            'fr': 'Déplacez votre panier n\'importe où sur l\'écran pour attraper les bons emojis qui tombent! Évitez les 5 types de mauvais emojis rouges brillants (💣☠️👻🔥💀). Commencez avec 3 cœurs - perdez-en un par mauvaise capture. Les avertissements visuels montrent quand le danger est proche!',
            'hi': 'गिरते अच्छे इमोजी को पकड़ने के लिए अपनी टोकरी को स्क्रीन पर कहीं भी ले जाएं! 5 प्रकार के चमकते लाल बुरे इमोजी से बचें (💣☠️👻🔥💀)। 3 दिलों के साथ शुरू करें - प्रति बुरे कैच एक खोएं। दृश्य चेतावनियाँ दिखाती हैं जब खतरा पास है!',
            'tl': 'Ilipat ang iyong basket kahit saan sa screen upang hulihin ang nahuhulog na mabubuting emoji! Iwasan ang 5 uri ng nagniningning na pulang masamang emoji (💣☠️👻🔥💀). Magsimula sa 3 puso - mawawalan ng isa sa bawat masamang huli. Nagpapakita ang visual na babala kapag malapit ang panganib!',
            'ja': '画面のどこでもバスケットを動かして、落ちてくる良い絵文字をキャッチしよう！5種類の光る赤い悪い絵文字を避けよう（💣☠️👻🔥💀）。3つのハートでスタート - 悪いキャッチごとに1つ失います。危険が近いとき視覚的警告が表示されます！'
        },
        'enter_name': {
            'en': 'Enter Your Name:',
